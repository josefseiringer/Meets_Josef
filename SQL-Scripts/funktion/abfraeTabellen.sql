select * from meets.dbo.Members
select * from Meets.dbo.Events
select * from meets.dbo.Membervalidation
select * from meets.dbo.Eventinvitations
select * from meets.dbo.Invitationstatus

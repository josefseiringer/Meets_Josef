...
insert into [Events] (member_id,eventdate,title,[description],viewpublic,location) values(1,'2016-25-09','Wordpress Einfhrung','Was ist ein CMS und wie installiere ich Wordpress',1,'U3-Zippererstrasse-->Simmeringer Hauptstrasse 58');
GO

insert into [Events] (member_id,eventdate,title,[description],viewpublic,location) values(2,'2016-30-09','Wordpress fortgeschritten','Arbeiten mit Themes und Styles',1,'U3-Zippererstrasse-->Simmeringer Hauptstrasse 58');
GO

insert into [Events] (member_id,eventdate,title,[description],viewpublic,location) values(3,'2016-15-10','C#-MVC Einfhrung','Was ist C# und MVC berhaupt',0,'U3-Zippererstrasse-->Simmeringer Hauptstrasse 58');
GO

insert into [Events] (member_id,eventdate,title,[description],viewpublic,location) values(4,'2016-18-10','C#-MVC fortgeschritten','Der eigene Webauftritt',0,'U3-Zippererstrasse-->Simmeringer Hauptstrasse 58');
GO
